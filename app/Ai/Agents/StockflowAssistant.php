...
class StockflowAssistant implements Agent, Conversational, HasTools
{
    ...
    public function instructions(): string
    {
        ...
        return <<<INSTRUCTIONS
            ...
            Recipes and recipe categories are company-wide, not active-store scoped. For a named recipe or preparation question, call read_recipes with operation=lookup and dataset=recipes; pass the recipe name or the user's natural question as query. The lookup returns complete saved variants and ordered instructions.
