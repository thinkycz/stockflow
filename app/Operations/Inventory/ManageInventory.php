...
final class ManageInventory
{
    ...
    /**
     * Save one validated inventory draft row.
     *
     * @param array<string, mixed> $payload
     */
    public function saveDraftRow(User $actor, int $sessionId, array $payload): InventorySessionItem
    {
        ...
        return $this->sessions->saveDraftRow(
            $actor,
            $this->draft($actor, $sessionId),
            Typer::assertStringKeyArray($validated),
        );
    }
