...
$toolForAction = static function (string $action): string {
    foreach ([
        ...
        'write_payroll' => ['close_payroll_report', 'reopen_payroll_report', 'add_payroll_worker', 'remove_payroll_worker', 'set_payroll_wage_override', 'reset_payroll_wage_override', 'create_payroll_adjustment', 'update_payroll_adjustment', 'delete_payroll_adjustment', 'distribute_payroll_tips'],
...
$matrix = [
    ...
    'supported' => [
        ...
        'payroll.tip-distributions.store' => ['operation' => 'distribute_payroll_tips'],
    ...
    'excluded' => [
        ...
        'bank-statements.update' => 'Sensitive bank statement review is deliberately excluded from chat.',
