...
<template>
    ...
    <div v-else class="overflow-x-auto">
        <DataTable>
            ...
            <tfoot>
                <tr>
                    <th class="border-t border-outline-glass pt-2 text-left">
                        Σ
                    </th>
                    <th class="border-t border-outline-glass pt-2 text-right">
                        {{ formatHours(totals.hours) }} h
                    </th>
                    <th
                        class="border-t border-outline-glass pt-2 text-right"
                        :aria-label="
                    ...
                    <th
                        v-if="showSalary"
                        class="border-t border-outline-glass pt-2 text-right text-on-surface"
                    >
